...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
                ...
                <nav class="navbar navbar-expand-lg navbar-dark bg-primary px-4">
                    ...
                    <div class="collapse navbar-collapse" id="navbarText">
                        <ul class="navbar-nav mr-auto">
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center mb-0" href="/"><ion-icon name="home-outline" class="px-1"></ion-icon>  Home <span class="sr-only">(current)</span></a>
                            </li>
                            <li class="nav-item">
    ...
    <xsl:template match="ARQELEM" mode="indice">
        <li class="list-group-item list-group-item-action">
            <a name="iarq{count(preceding-sibling::ARQELEM)}"></a>
            <a href="/arq/{count(preceding-sibling::ARQELEM)}">
    ...
    <xsl:template match="ARQELEM">
        <xsl:result-document href="./arq/{count(preceding-sibling::ARQELEM)}.html">
                ...
                <body>
                    ...
                    <section style="display:grid;grid-template-columns: 1fr 2.3fr 1fr; ">
                        ...
                        <xsl:for-each select="preceding-sibling::ARQELEM[1]">
                            <a href="/arq/{count(preceding-sibling::ARQELEM)}" style="font-size:7rem;">
                        ...
                        <main>
                            <div class="card m-5">
                                ...
                                <a href="/#iarq{count(preceding-sibling::ARQELEM)}" class="text-center h5 d-flex align-items-center justify-content-center">
